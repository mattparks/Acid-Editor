...
namespace Acid.Forms.Controls
{
    ...
    public class DarkButton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var textColor = Colours.LightText;
            var borderColor = Colours.GreySelection;
            var fillColor = _useGenericBackColor ? (_isDefault ? Colours.DarkBlueBackground : Colours.LightBackground) : BackColor;
            var hoverColor = _useGenericBackColor ? (_isDefault ? Colours.BlueBackground : Colours.LighterBackground) : ControlPaint.Light(BackColor);
            ...
            if (Enabled)
            {
                switch (ButtonStyle)
                {
                    case DarkButtonStyle.Normal:
                        if (Focused && TabStop)
                            borderColor = Colours.BlueHighlight;
                    ...
                    case DarkButtonStyle.Flat:
                        switch (ButtonState)
                        {
                            case DarkControlState.Normal:
                                ...
                                break;
                            case DarkControlState.Hover:
                                fillColor = Colours.MediumBackground;
                                break;
                            case DarkControlState.Pressed:
                                fillColor = Colours.DarkBackground;
                                break;
