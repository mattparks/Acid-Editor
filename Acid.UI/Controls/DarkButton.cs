...
namespace Acid.UI.Controls
{
	...
	public class DarkButton : Button
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			var fillColor = _isDefault ? Colours.DarkBlueBackground : Colours.LightBackground;
				...
				if (ButtonStyle == DarkButtonStyle.Normal)
				{
					...
					switch (ButtonState)
					{
						case DarkControlState.Hover:
							fillColor = _isDefault ? Colours.BlueBackground : Colours.LighterBackground;
							break;
						case DarkControlState.Pressed:
							fillColor = _isDefault ? Colours.DarkBackground : Colours.DarkBackground;
							break;
					}
				}
