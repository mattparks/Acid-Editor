...
namespace AcidEditor
{
    public partial class DialogSettings : DarkDialog
    {
        public DialogSettings()
        {
            ...
            {
                DarkMessageBox.ShowError("This is an error", "Acid Editor");
            };

            btnMessageBox.Click += delegate
            {
                DarkMessageBox.ShowInformation("This is some information, except it is much bigger, so there we go. I wonder how this is going to go. I hope it resizes properly. It probably will.", "Acid Editor");
            };
        }
    }
}
