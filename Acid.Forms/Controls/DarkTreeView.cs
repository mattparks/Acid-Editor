using Acid.Forms.Collections;
using Acid.Forms.Config;
using Acid.Forms.Extensions;
...
namespace Acid.Forms.Controls
{
    public class DarkTreeView : DarkScrollView
    {
        ...
        private void LoadIcons()
        {
            ...
            _nodeClosed = TreeViewIcons.node_closed_empty.SetColor(Colours.LightText);
            _nodeClosedHover = TreeViewIcons.node_closed_empty.SetColor(Colours.BlueHighlight);
            _nodeClosedHoverSelected = TreeViewIcons.node_closed_full.SetColor(Colours.LightText);
            _nodeOpen = TreeViewIcons.node_open.SetColor(Colours.LightText);
            _nodeOpenHover = TreeViewIcons.node_open.SetColor(Colours.BlueHighlight);
            _nodeOpenHoverSelected = TreeViewIcons.node_open_empty.SetColor(Colours.LightText);
        }
