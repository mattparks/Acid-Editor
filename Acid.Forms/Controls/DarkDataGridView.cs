...
namespace Acid.Forms.Controls
{
    public class DarkDataGridView : UserControl, ISupportInitialize
    {
        ...
        private static DataGridViewCellStyle GetCellStyle(bool isFocused, bool isOdd, bool isHeader)
        {
            ...
            {
                // Darker colors:
                // BackColor = isOdd ? Colours.MediumBackground : Colours.DarkBackground,
                BackColor = isHeader ? Colours.MediumBackground :
                        (isOdd ? Colours.GreyBackground : Colours.HeaderBackground),
                ForeColor = Colours.LightText,
                SelectionBackColor = isFocused ? Colours.BlueSelection : Colours.GreySelection,
                SelectionForeColor = Colours.LightText,
            };
        }
        ...
        public DarkDataGridView()
        {
            ...
            OutlineColor = Colours.LightBorder;
            ...
            _base.BackgroundColor = Colours.GreyBackground;
            _base.BackColor = _base.BackgroundColor;
            _base.GridColor = Colours.DarkBorder;
            ...
            _vScrollBar.BackColor = Colours.MediumBackground;
            _vScrollBar.Minimum = 0;
            _vScrollBar.Maximum = 0;
            _vScrollBar.ValueChanged += _vScrollBar_ValueChanged;

            _hScrollBar.BackColor = Colours.MediumBackground;
