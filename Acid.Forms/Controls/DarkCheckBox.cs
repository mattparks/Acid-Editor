...
namespace Acid.Forms.Controls
{
    public class DarkCheckBox : CheckBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var borderColor = Colours.LightText;
            var fillColor = Colours.LightestBackground;
            ...
            if (Enabled)
            {
                if (Focused)
                {
                    ...
                    fillColor = Colours.BlueSelection;
                }
                ...
                switch (_controlState)
                {
                    ...
                    case DarkControlState.Pressed:
                        borderColor = Colours.GreyHighlight;
                        fillColor = Colours.GreySelection;
                        break;
                }
            }
            else
